...
Here I determine some basic structurual information using nrow, ncol,
and colnames functions to see row count, column count, and variables
names, respectively.
...
**There are 7 columns and 2,595,176 rows in this dataset. Each row
appears to be a different data collection point on a given “date” from a
...
Below I make a boxplot to view the spread of the datapoints and find any
outliers.
...
![](P8105_HW3_KJF2152_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
Below I will use summarize() to view missing across all data collection
variables.
...
![](P8105_HW3_KJF2152_files/figure-gfm/unnamed-chunk-7-2.png)<!-- -->
